...
describe('AppointmentDayView', () => {
   ...
   it('renders each appointment in a li', () => {
      ...
      expect(
         container.querySelectorAll('li')).toHaveLength(2);
      expect(
   ...
   it('has a button element in each li', () => {
      render(<AppointmentsDayView appointments={appointments} />);
      expect(container.querySelectorAll('li > button'))
         .toHaveLength(2);
      expect(container.querySelectorAll('li > button')[0].type)
         .toEqual('button');
   })

   it('render appointments when selected', () => {
      render(<AppointmentsDayView appointments={appointments} />);
